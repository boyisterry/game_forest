...
export const COPY: Record<Locale, Copy> = {
  en: {
    ...
    minimapCityWorkshop: "Click to jump · connected residential, civic and industrial blocks",
    ...
    generateCity: "Build Cedar Crossing",
    ...
    statusCityReady: "Cedar Crossing ready · drag to look, arrow keys to move, click minimap to jump",
    ...
    statusBuildingCity: "Lighting the streets of Cedar Crossing…",
  ...
  zh: {
    ...
    minimapCityWorkshop: "点击跳跃 · 住宅、公共服务与工业街区道路相连",
